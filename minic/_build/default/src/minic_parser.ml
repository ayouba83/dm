...
module MenhirBasics = struct
  ...
  type token = 
    ...
    | IF
    | IDENT of (
# 13 "src/minic_parser.mly"
       (string)
# 37 "src/minic_parser.ml"
  )
    | GT
    | GE
    | FOR
...
# 11 "src/minic_parser.mly"
       (int)
# 51 "src/minic_parser.ml"
  )
    | COMA
    | BOOL_CST of (
# 12 "src/minic_parser.mly"
       (bool)
# 57 "src/minic_parser.ml"
  )
    | BOOL
    | BEGIN
    | ANDL
...
# 134 "src/minic_parser.mly"
                            ( instr )
# 152 "src/minic_parser.ml"
         in
...
and _menhir_goto_list_instruction_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Minic_ast.seq) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState127 ->
        ...
        let _1 = () in
        let _v : (Minic_ast.instr) = 
# 154 "src/minic_parser.mly"
                                                                                                    ( For(init, test, iter, s) )
# 205 "src/minic_parser.ml"
         in
...
# 215 "src/minic_parser.ml"
    ...
    | MenhirState139 ->
        ...
        let _1 = () in
        let _v : (Minic_ast.instr) = 
# 151 "src/minic_parser.mly"
                                                                                            ( If(e, s1, s2) )
# 288 "src/minic_parser.ml"
         in
        _menhir_goto_bloc_instr_form _menhir_env _menhir_stack _menhir_s _v
    | MenhirState99 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _1 = () in
        let _v : (Minic_ast.instr) = 
# 152 "src/minic_parser.mly"
                                                         ( While(e, s) )
# 302 "src/minic_parser.ml"
         in
        _menhir_goto_bloc_instr_form _menhir_env _menhir_stack _menhir_s _v
    | MenhirState94 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 128 "src/minic_parser.mly"
    ( { name=f; params=opt; return=t; locals=vars; code=s } )
# 326 "src/minic_parser.ml"
             in
            let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
            let _menhir_stack = Obj.magic _menhir_stack in
            assert (not _menhir_env._menhir_error);
...
# 179 "src/minic_parser.mly"
              ( e )
# 369 "src/minic_parser.ml"
         in
    ...
    | MenhirState94 | MenhirState99 | MenhirState110 | MenhirState139 | MenhirState120 | MenhirState124 | MenhirState127 | MenhirState129 ->
        ...
        let _v : (Minic_ast.instr) = 
# 147 "src/minic_parser.mly"
              ( Expr(e) )
# 381 "src/minic_parser.ml"
         in
  ...
  fun _menhir_env _menhir_stack _menhir_s _v _startpos ->
    ...
    | MenhirState94 | MenhirState99 | MenhirState110 | MenhirState139 | MenhirState127 | MenhirState129 ->
        ...
        | SEMI ->
            ...
            let _2 = () in
            let _v : (Minic_ast.instr) = 
# 133 "src/minic_parser.mly"
                        ( instr )
# 486 "src/minic_parser.ml"
             in
            _menhir_goto_instruction _menhir_env _menhir_stack _menhir_s _v
...
# 195 "src/minic_parser.mly"
                                  ( vd :: dl )
# 1207 "src/minic_parser.ml"
         in
    ...
    | MenhirState21 ->
        ...
        | END ->
            ...
            let _1 = () in
            let _v : (Minic_ast.expr) = 
# 161 "src/minic_parser.mly"
                        ( let arr = Array.of_list l in Array(arr) )
# 1225 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 13 "src/minic_parser.mly"
       (string)
# 1246 "src/minic_parser.ml"
            )), _startpos_f_), _, (params : (Minic_ast.expr list))) = _menhir_stack in
            let _4 = () in
            let _2 = () in
            let _startpos = _startpos_f_ in
            let _v : (Minic_ast.expr) = 
# 189 "src/minic_parser.mly"
                                     ( Call(f, params) )
# 1254 "src/minic_parser.ml"
             in
...
# 13 "src/minic_parser.mly"
       (string)
# 1384 "src/minic_parser.ml"
    )), _startpos_id_) = _menhir_stack in
    let _2 = () in
    let _startpos = _startpos_id_ in
    let _v : (Minic_ast.expr) = 
# 187 "src/minic_parser.mly"
                ( Incr( id ) )
# 1391 "src/minic_parser.ml"
     in
    _menhir_goto_expr_form _menhir_env _menhir_stack _menhir_s _v _startpos
...
# 13 "src/minic_parser.mly"
       (string)
# 1406 "src/minic_parser.ml"
    )), _startpos_id_) = _menhir_stack in
    let _2 = () in
    let _startpos = _startpos_id_ in
    let _v : (Minic_ast.expr) = 
# 188 "src/minic_parser.mly"
                ( Decr( id ) )
# 1413 "src/minic_parser.ml"
     in
    _menhir_goto_expr_form _menhir_env _menhir_stack _menhir_s _v _startpos
  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState9 | MenhirState18 | MenhirState54 | MenhirState21 ->
        ...
        | END | RPAR ->
            ...
            let _v : (Minic_ast.expr list) = 
# 194 "src/minic_parser.mly"
               ( [e] )
# 1489 "src/minic_parser.ml"
             in
            _menhir_goto_args_list _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState23 ->
        ...
        | ANDL | BOOL | COMA | END | EOF | FOR | IDENT _ | IF | INT | OR | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE | XOR ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 178 "src/minic_parser.mly"
                                 ( Xor(a, b) )
# 1532 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState25 ->
        ...
        | AND | ANDL | BOOL | COMA | END | EOF | EQ | FOR | GE | GT | IDENT _ | IF | INT | LE | LT | NE | OR | ORL | PLUS | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | SUB | VOID | WHILE | XOR ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 165 "src/minic_parser.mly"
                                 ( Sub(a, b) )
# 1557 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState27 ->
        ...
        let _2 = () in
        let _v : (Minic_ast.expr) = 
# 162 "src/minic_parser.mly"
                                 ( Mul(a, b) )
# 1574 "src/minic_parser.ml"
         in
        _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
    | MenhirState30 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _2 = () in
        let _v : (Minic_ast.expr) = 
# 164 "src/minic_parser.mly"
                                 ( Div(a, b) )
# 1585 "src/minic_parser.ml"
         in
        _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
    | MenhirState32 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        | AND | ANDL | BOOL | COMA | END | EOF | EQ | FOR | GE | GT | IDENT _ | IF | INT | LE | LT | NE | OR | ORL | PLUS | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | SUB | VOID | WHILE | XOR ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 163 "src/minic_parser.mly"
                                 ( Add(a, b) )
# 1604 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState34 ->
        ...
        | AND | ANDL | BOOL | COMA | END | EOF | EQ | FOR | IDENT _ | IF | INT | NE | OR | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE | XOR ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 170 "src/minic_parser.mly"
                                 ( Ne(a, b) )
# 1641 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState36 ->
        ...
        | AND | ANDL | BOOL | COMA | END | EOF | EQ | FOR | GE | GT | IDENT _ | IF | INT | LE | LT | NE | OR | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE | XOR ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 167 "src/minic_parser.mly"
                                 ( Lt(a, b) )
# 1670 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState38 ->
        ...
        | AND | ANDL | BOOL | COMA | END | EOF | EQ | FOR | GE | GT | IDENT _ | IF | INT | LE | LT | NE | OR | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE | XOR ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 171 "src/minic_parser.mly"
                                 ( Le(a, b) )
# 1699 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState40 ->
        ...
        | AND | ANDL | BOOL | COMA | END | EOF | EQ | FOR | GE | GT | IDENT _ | IF | INT | LE | LT | NE | OR | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE | XOR ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 168 "src/minic_parser.mly"
                                 ( Gt(a, b) )
# 1728 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState42 ->
        ...
        | AND | ANDL | BOOL | COMA | END | EOF | EQ | FOR | GE | GT | IDENT _ | IF | INT | LE | LT | NE | OR | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE | XOR ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 172 "src/minic_parser.mly"
                                 ( Ge(a, b) )
# 1757 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState44 ->
        ...
        | AND | ANDL | BOOL | COMA | END | EOF | EQ | FOR | IDENT _ | IF | INT | NE | OR | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE | XOR ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 169 "src/minic_parser.mly"
                                 ( Eq(a, b) )
# 1794 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState46 ->
        ...
        | AND | ANDL | BOOL | COMA | END | EOF | FOR | IDENT _ | IF | INT | OR | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE | XOR ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 176 "src/minic_parser.mly"
                                 ( And(a, b) )
# 1835 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState48 ->
        ...
        | BOOL | COMA | END | EOF | FOR | IDENT _ | IF | INT | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 175 "src/minic_parser.mly"
                                 ( Orl(a, b) )
# 1884 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState50 ->
        ...
        | ANDL | BOOL | COMA | END | EOF | FOR | IDENT _ | IF | INT | OR | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 177 "src/minic_parser.mly"
                                 ( Or(a, b) )
# 1929 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState52 ->
        ...
        | ANDL | BOOL | COMA | END | EOF | FOR | IDENT _ | IF | INT | ORL | PTRB | PTRI | PUTCHAR | RBRK | RETURN | RPAR | SEMI | VOID | WHILE ->
            ...
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 174 "src/minic_parser.mly"
                                 ( Andl(a, b) )
# 1976 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 13 "src/minic_parser.mly"
       (string)
# 2023 "src/minic_parser.ml"
            )), _startpos_tab_), _, (n : (Minic_ast.expr))) = _menhir_stack in
            let _4 = () in
            let _2 = () in
            let _v : (Minic_ast.expr) = 
# 182 "src/minic_parser.mly"
                                   ( Elm(n, tab) )
# 2030 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | SUB ->
            _menhir_run25 _menhir_env (Obj.magic _menhir_stack)
    ...
    | MenhirState12 ->
        ...
        | RPAR ->
            ...
            let _1 = () in
            let _v : (Minic_ast.expr) = 
# 181 "src/minic_parser.mly"
                         ( Par(e) )
# 2084 "src/minic_parser.ml"
             in
            _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
        | SUB ->
            _menhir_run25 _menhir_env (Obj.magic _menhir_stack)
    ...
    | MenhirState11 ->
        ...
        let _1 = () in
        let _v : (Minic_ast.expr) = 
# 173 "src/minic_parser.mly"
                    ( Not(b) )
# 2105 "src/minic_parser.ml"
         in
        _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
    | MenhirState10 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        ...
        let _1 = () in
        let _v : (Minic_ast.expr) = 
# 166 "src/minic_parser.mly"
                                ( Opp(a) )
# 2116 "src/minic_parser.ml"
         in
        _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
    | MenhirState78 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 2166 "src/minic_parser.ml"
    ...
    | MenhirState100 ->
        ...
        | END | FOR | IDENT _ | IF | PUTCHAR | RETURN | RPAR | SEMI | WHILE ->
            ...
            let _v : (Minic_ast.instr) = 
# 148 "src/minic_parser.mly"
                      ( Return(e) )
# 2293 "src/minic_parser.ml"
             in
            _menhir_goto_instr_form _menhir_env _menhir_stack _menhir_s _v _startpos
        | _ ->
            assert (not _menhir_env._menhir_error);
    ...
    | MenhirState103 ->
        ...
        | RPAR ->
            ...
            let _startpos = _startpos__1_ in
            let _v : (Minic_ast.instr) = 
# 145 "src/minic_parser.mly"
                                 ( Putchar(e) )
# 2345 "src/minic_parser.ml"
             in
            _menhir_goto_instr_form _menhir_env _menhir_stack _menhir_s _v _startpos
        | SUB ->
            _menhir_run25 _menhir_env (Obj.magic _menhir_stack)
...
# 13 "src/minic_parser.mly"
       (string)
# 2473 "src/minic_parser.ml"
            )), _startpos_id_), _, (e : (Minic_ast.expr))) = _menhir_stack in
            let _2 = () in
            let _startpos = _startpos_id_ in
            let _v : (Minic_ast.instr) = 
# 146 "src/minic_parser.mly"
                            ( Set(id, e) )
# 2480 "src/minic_parser.ml"
             in
            _menhir_goto_instr_form _menhir_env _menhir_stack _menhir_s _v _startpos
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 2606 "src/minic_parser.ml"
            ...
            let _v : (Minic_ast.instr) = 
# 144 "src/minic_parser.mly"
                                                      ( Insert(pos, e, tab) )
# 2615 "src/minic_parser.ml"
             in
            _menhir_goto_instr_form _menhir_env _menhir_stack _menhir_s _v _startpos
        | _ ->
            assert (not _menhir_env._menhir_error);
...
and _menhir_reduce1 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    let _v : (Minic_ast.expr list) = 
# 193 "src/minic_parser.mly"
              ( [] )
# 2697 "src/minic_parser.ml"
     in
    _menhir_goto_args_list _menhir_env _menhir_stack _menhir_s _v
...
and _menhir_goto_variable_decl_form : _menhir_env -> 'ttv_tail -> _menhir_state -> (Minic_ast.var_decl) -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v _startpos ->
    ...
    | SEMI ->
        ...
        let _2 = () in
        let _v : (Minic_ast.var_decl) = 
# 84 "src/minic_parser.mly"
                                  ( var_dcl )
# 2717 "src/minic_parser.ml"
         in
...
# 13 "src/minic_parser.mly"
       (string)
# 2849 "src/minic_parser.ml"
                )), _startpos_tab_) = _menhir_stack in
                let _4 = () in
                let _2 = () in
                let _1 = () in
                let _v : (Minic_ast.expr) = 
# 183 "src/minic_parser.mly"
                             ( Len(tab) )
# 2857 "src/minic_parser.ml"
                 in
                _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
            | _ ->
                assert (not _menhir_env._menhir_error);
...
# 13 "src/minic_parser.mly"
       (string)
# 2925 "src/minic_parser.ml"
        )), _startpos_n_) = _menhir_stack in
        let _v : (Minic_ast.expr) = 
# 180 "src/minic_parser.mly"
            ( Get(n) )
# 2930 "src/minic_parser.ml"
         in
        _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 11 "src/minic_parser.mly"
       (int)
# 2951 "src/minic_parser.ml"
    )) = _v in
    let _v : (Minic_ast.expr) = 
# 159 "src/minic_parser.mly"
        ( Cst(n) )
# 2956 "src/minic_parser.ml"
     in
    _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
...
# 12 "src/minic_parser.mly"
       (bool)
# 2971 "src/minic_parser.ml"
    )) = _v in
    let _v : (Minic_ast.expr) = 
# 160 "src/minic_parser.mly"
             ( BCst(b) )
# 2976 "src/minic_parser.ml"
     in
    _menhir_goto_expression _menhir_env _menhir_stack _menhir_s _v
...
# 106 "src/minic_parser.mly"
                                  ( vd :: dl )
# 3064 "src/minic_parser.ml"
         in
...
# 100 "src/minic_parser.mly"
                    ( (fst(t), Tab(snd t)) )
# 3093 "src/minic_parser.ml"
             in
...
and _menhir_goto_param_dcl : _menhir_env -> 'ttv_tail -> _menhir_state -> (string * Minic_ast.typ) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | RPAR ->
        ...
        let _v : ((string * Minic_ast.typ) list) = 
# 105 "src/minic_parser.mly"
              ( [p] )
# 3186 "src/minic_parser.ml"
         in
        _menhir_goto_param_list _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 13 "src/minic_parser.mly"
       (string)
# 3199 "src/minic_parser.ml"
) * Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack ->
    let ((_menhir_stack, _menhir_s, (typ : (Minic_ast.typ)), _startpos_typ_), (var : (
# 13 "src/minic_parser.mly"
       (string)
# 3205 "src/minic_parser.ml"
    )), _startpos_var_) = _menhir_stack in
    let _startpos = _startpos_typ_ in
    let _v : (Minic_ast.var_decl) = 
# 96 "src/minic_parser.mly"
                    ( (var, typ, None) )
# 3211 "src/minic_parser.ml"
     in
    _menhir_goto_variable_decl_form _menhir_env _menhir_stack _menhir_s _v _startpos
...
and _menhir_reduce53 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    let _v : ((string * Minic_ast.typ) list) = 
# 104 "src/minic_parser.mly"
              ( [] )
# 3250 "src/minic_parser.ml"
     in
    _menhir_goto_param_list _menhir_env _menhir_stack _menhir_s _v
...
# 13 "src/minic_parser.mly"
       (string)
# 3270 "src/minic_parser.ml"
        )), _startpos_tab_) = _menhir_stack in
        let _4 = () in
        let _3 = () in
        let _startpos = _startpos_typ_ in
        let _v : (string * Minic_ast.typ) = 
# 99 "src/minic_parser.mly"
                             ( (tab, Tab(typ)) )
# 3278 "src/minic_parser.ml"
         in
        _menhir_goto_vector _menhir_env _menhir_stack _menhir_s _v _startpos
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 77 "src/minic_parser.mly"
                                       ( let vl, fl = dl in
                                         vl, fd :: fl )
# 3315 "src/minic_parser.ml"
         in
    ...
    | MenhirState75 ->
        ...
        let _v : (Minic_ast.var_decl list * Minic_ast.fun_def list) = 
# 75 "src/minic_parser.mly"
                                       ( let vl, fl = dl in
                                         vd :: vl, fl )
# 3326 "src/minic_parser.ml"
         in
        _menhir_goto_declaration_list _menhir_env _menhir_stack _menhir_s _v
    | MenhirState0 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
# 13 "src/minic_parser.mly"
       (string)
# 3438 "src/minic_parser.ml"
                    )), _startpos_x_) = _menhir_stack in
                    let _4 = () in
                    let _3 = () in
                    let _v : (string * Minic_ast.typ) = 
# 110 "src/minic_parser.mly"
                         ( (x, Tab(t)) )
# 3445 "src/minic_parser.ml"
                     in
...
# 13 "src/minic_parser.mly"
       (string)
# 3459 "src/minic_parser.ml"
                )), _startpos_x_) = _menhir_stack in
                let _v : (string * Minic_ast.typ) = 
# 109 "src/minic_parser.mly"
               ( (x, t) )
# 3464 "src/minic_parser.ml"
                 in
                _menhir_goto_param_dcl _menhir_env _menhir_stack _menhir_s _v
            | _ ->
                assert (not _menhir_env._menhir_error);
...
# 41 "src/minic_parser.mly"
      (Minic_ast.prog)
# 3710 "src/minic_parser.ml"
        ) = let _startpos = _startpos__1_ in
        
# 63 "src/minic_parser.mly"
        ( let pos = _startpos in
          let message =
            Printf.sprintf
              "Syntax error at %d, %d"
...
and _menhir_reduce7 : _menhir_env -> 'ttv_tail -> _menhir_state -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s ->
    let _v : (Minic_ast.var_decl list * Minic_ast.fun_def list) = 
# 74 "src/minic_parser.mly"
             ( [], [] )
# 3730 "src/minic_parser.ml"
     in
    _menhir_goto_declaration_list _menhir_env _menhir_stack _menhir_s _v
...
# 117 "src/minic_parser.mly"
       ( Void )
# 3744 "src/minic_parser.ml"
     in
...
and _menhir_run3 : _menhir_env -> 'ttv_tail -> _menhir_state -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _startpos ->
    ...
    let _startpos = _startpos__1_ in
    let _v : (Minic_ast.typ) = 
# 119 "src/minic_parser.mly"
       ( Ptr(Int) )
# 3758 "src/minic_parser.ml"
     in
    _menhir_goto_typ _menhir_env _menhir_stack _menhir_s _v _startpos
...
and _menhir_run4 : _menhir_env -> 'ttv_tail -> _menhir_state -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _startpos ->
    ...
    let _startpos = _startpos__1_ in
    let _v : (Minic_ast.typ) = 
# 118 "src/minic_parser.mly"
       ( Ptr(Bool) )
# 3772 "src/minic_parser.ml"
     in
    _menhir_goto_typ _menhir_env _menhir_stack _menhir_s _v _startpos
...
and _menhir_run5 : _menhir_env -> 'ttv_tail -> _menhir_state -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _startpos ->
    ...
    let _startpos = _startpos__1_ in
    let _v : (Minic_ast.typ) = 
# 115 "src/minic_parser.mly"
      ( Int )
# 3786 "src/minic_parser.ml"
     in
    _menhir_goto_typ _menhir_env _menhir_stack _menhir_s _v _startpos
...
and _menhir_run6 : _menhir_env -> 'ttv_tail -> _menhir_state -> Lexing.position -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _startpos ->
    ...
    let _startpos = _startpos__1_ in
    let _v : (Minic_ast.typ) = 
# 116 "src/minic_parser.mly"
       ( Bool )
# 3800 "src/minic_parser.ml"
     in
    _menhir_goto_typ _menhir_env _menhir_stack _menhir_s _v _startpos
